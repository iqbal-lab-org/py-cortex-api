...
if [ -z "${match_py2}" ]; then
    ...
    "Warning: Running gramtools \`discover\` as is will fail (due to stampy.py requiring python 2)\n" \
    "Warning: Please make sure /usr/bin/env python points to a python 2." 1>&2
fi
